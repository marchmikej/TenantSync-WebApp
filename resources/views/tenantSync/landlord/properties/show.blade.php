			...
			<form action="/landlord/properties/{{$property->id}}" method="Post" class="form form-horizontal">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<div class="form-group">
							<label class="control-label col-sm-3" for="mortage_term">Mortgage Term</label>
							<div class="col-sm-9">
								<input class="form-control" type="text" name="mortage_term" placeholder="Number of months" value="{{ $property->mortgage_term }}"/>
							</div>
						</div>
					</div>
				</div>
