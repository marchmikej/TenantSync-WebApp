			...
			<ul class="nav navbar-nav">
									...
									<div class="col-md-4">
										<ul class="mega-menu-submenu">
											...
											<li>
												...
												Layout with Fontawesome Icons</a>
											</li>
											<li>
										...
										<div class="row">
											<div class="col-md-4">
												<ul class="mega-menu-submenu">
													...
													<li>
														<a href="layout_fontawesome_icons.html">
														<i class="fa fa-angle-right"></i> Layout with Fontawesome Icons</a>
													</li>
													<li>
														<a href="layout_glyphicons.html">
				...
				<li class="classic-menu-dropdown">
					...
					<ul class="dropdown-menu pull-left">
						<li>
							<a href="javascript:;">
							<i class="glyphicon glyphicon-search"></i> Section 1 </a>
						</li>
						<li>
							<a href="javascript:;">
							<i class="glyphicon glyphicon-trash"></i> Section 2 </a>
						</li>
						<li>
							<a href="javascript:;">
							<i class="glyphicon glyphicon-flag"></i> Section 3 </a>
						</li>
						<li>
							<a href="javascript:;">
							<i class="glyphicon glyphicon-camera"></i> Section 4 </a>
						</li>
						<li>
							<a href="javascript:;">
							<i class="glyphicon glyphicon-tint"></i> Section 5 </a>
						</li>
						<li class="dropdown-submenu">
							<a href="javascript:;">
							<i class="glyphicon glyphicon-warning-sign"></i> More options </a>
							<ul class="dropdown-menu">
								<li>
									<a href="javascript:;">
									Second level link </a>
			...
			<li>
				...
				<ul class="sub-menu">
					<li>
						...
						<i class="glyphicon glyphicon-star-empty"></i> General Portlets </a>
					</li>
					<li>
						<a href="portlet_draggable.html">
						<i class="glyphicon glyphicon-tint"></i> Draggable Portlets </a>
					</li>
				</ul>
			</li>
			<li>
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="glyphicon glyphicon-headphones"></i>Simple Table
							</div>
							<div class="tools">
				...
				<div class="col-md-6">
					...
					<div class="portlet box yellow">
						<div class="portlet-title">
							<div class="caption">
								<i class="glyphicon glyphicon-gift"></i>Bordered Table
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
